...
PROJECT_NAME ?= provider-arubacloud
PROJECT_REPO ?= github.com/arubacloud/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-arubacloud_v1.1.1_x5
...
REGISTRY_ORGS ?= ghcr.io/arubacloud
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/arubacloud
# xpkg.upbound.io does not support promotion via docker buildx imagetools create.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/arubacloud
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-arubacloud: do.build.images
